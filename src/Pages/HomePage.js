...
const HomePage = () => {
  ...
  // Initialize dispatch and access Redux state
  const dispatch = useDispatch();
const username = useSelector(selectUsername);


// Handle function to update username in Redux
const handleSetUsername = () => {
  dispatch(setUsername(name)); // Update username with the value from the input field
};
